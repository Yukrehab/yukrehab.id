...
<html lang="id">
    ...
    <body>
        ...
        <div>
            <h1 style="text-align: center; margin : 30px 0 10px 0; font-size: 36px;">BAHAYA NARKOBA!!!</h1>
        ...
        <main>
            <section class="sec1">
                    ...
                    <div class="sec1-text">
                        ...
                        <div class="sec1-text-p">
                            <p>
                                ...
                                bagian dada. Jangka panjang dari dampak dehidrasi ini dapat menyebabkan kerusakan pada otak.
                    ...
                    <div class="sec1-text">
                        ...
                        <div class="sec1-text-p">
                            <p>
                                ...
                                bisa mengakibatkan dampak yang lebih buruk seperti gangguan mental, depresi, serta kecemasan terus-menerus.
                            </p>
                        </div>
                    </div>
                    <img
                        src="/assets/artikel/4/2.gif" 
                        alt=""
                    /> 
                </section>
                <section class="sec1">
                    <img
                        src="/assets/artikel/4/3.jpg"
                        alt=""
                    />

                    <div class="sec1-text">
                        <h2>Menurunnya Tingkat Kesadaran</h2>
                        <div class="sec1-text-p">
                            <p>
                                ...
                                narkoba yang cukup berisiko tinggi adalah hilangnya ingatan sehingga sulit mengenali lingkungan sekitar.
                            </p>
                        </div>
                    </div>
                </section>
                <section class="sec1">
                    <div class="sec1-text">
                        <h2>Gangguan Kualitas Hidup</h2>
                        <div class="sec1-text-p">
                            <p>
                                Bahaya narkoba bukan hanya berdampak buruk bagi kondisi tubuh, penggunaan obat-obatan 
                                tersebut juga bisa mempengaruhi kualitas hidup misalnya susah berkonsentrasi saat 
                                bekerja, mengalami masalah keuangan, hingga harus berurusan dengan pihak kepolisian jika terbukti melanggar hukum
                            </p>
                        </div>
                    </div>

                    <img
                        src="/assets/artikel/4/4.jpeg"
                        alt=""
                    />
                </section>
                <section class="sec1">
                    <img
                        src="/assets/artikel/4/5.gif"
                        alt=""
                    />
                ...
                <section class="sec1">
                    <div  style="width= fit-content; font-size: 20px;color: #313131;">
                        <p>
                            Pemakaian zat-zat narkotika hanya diperbolehkan untuk kepentingan medis sesuai dengan pengawasan dokter 
                            dan juga untuk keperluan penelitian. Selebihnya, obat-obatan tersebut tidak memberikan dampak positif 
                            bagi tubuh. Yang ada, kualitas hidup menjadi terganggu, relasi dengan keluarga kacau, kesehatan menurun, 
                            dan yang paling buruk adalah menyebabkan kematian. Karena itu, jangan coba-coba memakai barang berbahaya 
                            tersebut karena resikonya sangat tinggi bagi hidup dan kesehatan.
                        </p>
                    </div>
            </section>
        </main>
