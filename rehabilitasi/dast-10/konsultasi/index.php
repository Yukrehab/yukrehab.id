...
<html lang="id">
    ...
    <body>
        ...
        <div class="container">
            <div class="textinsidecons" style="max-width: 840px">
                <h1>
                    Setelah Melihat Hasil DAST-10 Anda,Apakah anda ingin membuat
                    jadwal rehabilitasi?
                </h1>
            </div>
            <div style="display: flex">
                <a class="buttonys answer-btn yes" href="/booking"> YA </a>
                <a class="buttonys answer-btn no" href="/"> TIDAK </a>
            </div>
            <div class="image-konsultasipage">
                <img src="/assets/konsulkah.png" alt="Gambar Konsultasi Page" />
            </div>
        </div>
